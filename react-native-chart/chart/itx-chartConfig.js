...
infChart.settings = {
    ...
    toolbar: {
        ...
        leftTb: ["select", "line", "rect", "pattern", "fibonacci", "andrewsPitchfork", "regression", "label", "arrow", "positions", "multiple", "delete","deleteAll","favorite"], //
